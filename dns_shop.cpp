#include "dns_shop.h"
#include "ui_dns_shop.h"
#include <QFile>
#include "output.h"
#include <QMessageBox>

dns_shop::dns_shop(QWidget *parent)
    : QDialog(parent)
    , ui(new Ui::dns_shop)
{
    ui->setupUi(this);
...
void dns_shop::setName(QString namme){
    name = namme;
}

void dns_shop::WriteTable(){
    READ();
...
void dns_shop::push_to_list(stuff b){
...
void dns_shop::on_pushButton_2_clicked(){
    ADD(0);
}


void dns_shop::on_pushButton_3_clicked(){
ADD(1);
}


void dns_shop::on_pushButton_4_clicked()
{
ADD(2);
}


void dns_shop::on_pushButton_5_clicked()
{
ADD(3);
}


void dns_shop::on_pushButton_clicked()
{
    WRITE();
    this->close();
